...
// Расширение для замены SendAsync в HttpMessageHandler
public static class HttpMessageHandlerExtensions
{
    public static Task<HttpResponseMessage> SendAsync(this HttpMessageHandler handler, HttpRequestMessage request, CancellationToken cancellationToken = default)
    {
        return ((HttpMessageHandler)handler).SendAsync(request, cancellationToken);
    }
}